...
const Footer = () => {
    ...
    const showFooter = location.pathname == '/contact' ? 'hidden' : 'block'
    return (
        <footer
            className={`${showFooter} text-center text-surface/75 `} >
            <div
                ...
                <div className="flex justify-center">
                    ...
                    <a href="https://github.com/Raha7325" className="[&>svg]:h-6 [&>svg]:w-6" target="_blank">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="black"
                            viewBox="0 0 496 512">
